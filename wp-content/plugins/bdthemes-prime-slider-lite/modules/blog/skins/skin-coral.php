...
class Skin_Coral extends Elementor_Skin_Base
{
    ...
    public function render_item_content( $post )
    {
        ...
        $parallax_text = 'bdt-slideshow-parallax="y: 60,0,-50; opacity: 1,1,0"';
        ?>
      ...
      <div class="bdt-slideshow-content-wrapper">
          ...
          <div class="bdt-prime-slider-content">
            <div class="bdt-prime-slider-desc" bdt-grid>
              <div class="bdt-width-1-1 bdt-width-2-3@s">
                ...
                <div bdt-slideshow-parallax="y: 20,0,-20; opacity: 1,1,0">
                  <?php 
        ...
        ?>
              ...
              <!-- <div bdt-slideshow-parallax="y: 80,0,-60; opacity: 1,1,0"> -->
                <?php 
