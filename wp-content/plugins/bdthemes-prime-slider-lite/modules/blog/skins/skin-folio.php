...
class Skin_Folio extends Elementor_Skin_Base
{
      ...
      <?php 
        ...
        <?php 
          ...
          <div class="bdt-prime-slider-meta bdt-flex bdt-flex-middle" bdt-slideshow-parallax="x: 250,-250">
            ...
            <div class="bdt-meta-author">
              <span class="bdt-author bdt-text-capitalize"><?php 
                esc_html_e( 'Written by&nbsp;', 'bdthemes-prime-slider' );
                echo  esc_attr( get_the_author() ) ;
                ?> </span><br>
              <span><?php 
                esc_html_e( 'On&nbsp;', 'bdthemes-prime-slider' );
                echo  get_the_date() ;
                ?></span>
            </div>
          </div>
        ...
        <?php 
          ...
          <div class="bdt-ps-meta bdt-visible@m">
            <div class="bdt-ps-meta-item bdt-flex bdt-flex-middle" bdt-slideshow-parallax="y: 140,0,-140; opacity: 1,1,0">
        ...
        <?php 
            ...
            if ( 'yes' == $settings['show_comments'] ) {
                ?>
          <div class="bdt-ps-meta bdt-visible@m">
            <div class="bdt-ps-meta-item bdt-flex bdt-flex-middle" bdt-slideshow-parallax="y: 170,0,-170; opacity: 1,1,0">
              <div class="bdt-meta-icon">
  ...
  <?php 
    ...
    {
        $settings = $this->parent->get_settings_for_display();
        $parallax_title = 'bdt-slideshow-parallax="y: 100,0,-80; opacity: 1,1,0"';
        $parallax_text = 'bdt-slideshow-parallax="y: 110,0,-90; opacity: 1,1,0"';
        ?>
