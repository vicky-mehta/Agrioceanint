...
class Skin_Crelly extends Elementor_Skin_Base
{
    ...
    public function render_navigation_arrows()
    {
        ...
        if ( $settings['show_navigation_arrows'] ) {
            ?>
                ...
                <div class="bdt-navigation-arrows bdt-position-bottom-left bdt-margin-large-bottom">
    ...
    public function rendar_item_content( $slide_content )
    {
        ...
        $parallax_sub_title = 'bdt-slideshow-parallax="x: 300,0,-100; opacity: 1,1,0"';
        $parallax_title = 'bdt-slideshow-parallax="x: 500,0,-100; opacity: 1,1,0"';
        $parallax_excerpt = 'bdt-slideshow-parallax="y: 200,0,-100; opacity: 1,1,0"';
        ?>
        ...
        if ( $slide_content['excerpt'] && 'yes' == $settings['show_excerpt'] ) {
            ...
            ?>
                        ...
                        <div bdt-slideshow-parallax="y: 200,0,-100; opacity: 1,1,0">
                            <?php 
