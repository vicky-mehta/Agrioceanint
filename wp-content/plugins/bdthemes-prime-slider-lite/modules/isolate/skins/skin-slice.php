...
class Skin_Slice extends Elementor_Skin_Base
{
    ...
    protected function render_play_button( $slide )
    {
        ...
        $this->parent->add_render_attribute(
            'lightbox',
            'class',
            'bdt-slide-play-button bdt-position-bottom-right',
            true
        );
        $this->parent->add_render_attribute(
            'lightbox',
        ...
        ?>     
		<div <?php 
        $this->parent->print_render_attribute_string( 'lightbox' );
        ?>>			

			<a <?php 
        $this->parent->print_render_attribute_string( 'lightbox-content' );
        ?>>
    ...
    public function render_item_content( $slide_content )
    {
        ...
        if ( $settings['animation_parallax'] == 'yes' ) {
            ...
            $parallax_title = ' bdt-slideshow-parallax="y: 75,0,-75; opacity: 1,1,0"';
        }
