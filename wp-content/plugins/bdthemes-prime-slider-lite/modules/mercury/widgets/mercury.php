    ...
    class Mercury extends Widget_Base {
        ...
        protected function register_controls() {
            ...
            $this->add_control(
                'content_reverse',
                [
                    'label'   => esc_html__( 'Content Reverse', 'bdthemes-prime-slider' ),
        ...
        public function render_excerpt($excerpt_length) {
            ...
            ?>
            <div class="bdt-desc" data-swiper-parallax="-150" data-swiper-parallax-duration="1100">
                <?php
                if (has_excerpt()) {
                    the_excerpt();
                } else {
            ...
            <div <?php echo $this->get_render_attribute_string('thumb-item'); ?>>
                <div class="bdt-content">
                    ...
                    <?php if ($settings['show_author'] or $settings['show_date']) : ?>
                        <div class="bdt-meta" data-swiper-parallax="-300" data-swiper-parallax-duration="800">
