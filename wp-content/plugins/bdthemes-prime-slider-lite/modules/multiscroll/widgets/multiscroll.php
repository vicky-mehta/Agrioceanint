...
class Multiscroll extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
            'content_position',
            [
                'label'   => __( 'Content Position', 'bdthemes-prime-slider' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options'   => [
					'text-left'   => [
		...
		$this->add_control(
			'show_description',
			[
				'label'   => esc_html__( 'Show Description', 'bdthemes-prime-slider' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
            'button_position',
            [
                'label'   => __( 'Button Position', 'bdthemes-prime-slider' ),
		...
		$this->add_control(
            'navigationPosition',
            [
                'label'   => __( 'Navigation Position', 'bdthemes-prime-slider' ),
                'type' 	  => Controls_Manager::SELECT,
				'default' => 'right',
                'options' => [
                    'right'      => __( 'Right', 'bdthemes-prime-slider' ),
