    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-rubix-slider .bdt-main-slider .bdt-meta .bdt-date-time i.eicon-calendar' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-rubix-slider .bdt-main-slider .bdt-meta .bdt-date-time i.eicon-calendar',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-rubix-slider .bdt-main-slider .bdt-meta .bdt-date-time i.eicon-calendar' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-rubix-slider .bdt-main-slider .bdt-meta .bdt-date-time i.eicon-calendar' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-rubix-slider .bdt-main-slider .bdt-meta .bdt-date-time i.eicon-calendar' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'thumb_line_heading',
            [
                'label'     => esc_html__('L I N E', 'bdthemes-prime-slider'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        ...
        $this->add_control(
            'thumb_meta_heading',
            [
                'label'     => esc_html__('M E T A', 'bdthemes-prime-slider'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
...
?>
    ...
    ?>
        <div <?php $this->print_render_attribute_string('prime-slider-rubix'); ?>>
            <div class="swiper-container bdt-main-slider">
            ...
            <div <?php echo $this->get_render_attribute_string('slider-item'); ?>>
                    ...
                    <?php if ($settings['show_read_more']) : ?>
                        <div class="bdt-read-more">
                            <a href="<?php echo esc_url(get_permalink()); ?>">
                                ...
                                <span><?php echo esc_html__($settings['read_more_text']) ?></span>
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="bdt-content">
                    ...
                    <?php if ($settings['show_date']) : ?>
                        <div class="bdt-meta bdt-flex-inline">
        ...
        ?>
            ...
            ?>
            <div thumbsSlider="" class="swiper-container bdt-thumb-slider">
                <div class="swiper-wrapper">
                    <?php
                    while ($wp_query->have_posts()) {
                        $wp_query->the_post();
