...
?>
        <div class="bdt-storker-img" style="background-image: url('<?php echo esc_url($image_final_src); ?>')"></div>
    <?php
    }
    ...
    public function render_title() {
        ...
        $this->add_render_attribute('slider-title', 'class', 'bdt-storker-title', true);
    ...
    ?>
        <div class="bdt-storker-text" data-swiper-parallax-y="-80" data-swiper-parallax-duration="600">
            <?php
            if (has_excerpt()) {
                the_excerpt();
            } else {
    ...
    ?>
        <div class="bdt-storker-category" data-swiper-parallax-y="-120" data-swiper-parallax-duration="400">
        ...
        <div <?php $this->print_render_attribute_string('prime-slider-storker'); ?>>
            ...
            public function render_footer() {
                ...
                <?php if ($settings['show_navigation_dots']) : ?>
                    <div class="bdt-storker-pagination">
    ...
    ?>
        <div class="bdt-prime-slider">
            ...
            ?>
            <div thumbsSlider="" class="swiper-container bdt-storker-thumbs">
                <div class="swiper-wrapper">
                    <?php
                    while ($wp_query->have_posts()) {
                        $wp_query->the_post();
