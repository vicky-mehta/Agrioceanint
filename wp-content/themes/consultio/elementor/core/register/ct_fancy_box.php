                    ...
                    'controls' => array(
                        array(
                            ...
                            'options' => [
                                ...
                                '20' => [
                                    'label' => esc_html__('Layout 20', 'consultio' ),
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/ct_fancy_box/layout-image/layout20.jpg'
                                ],
                            ],
                        ),
                    ),
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .ct-fancy-box .item--icon svg' => 'fill: {{VALUE}};',
                            ],
                            'condition' => [
                                'layout' => ['1','2'],
                            ],
