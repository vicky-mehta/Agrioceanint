...
$grid_sizer = "col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12";
...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-blog-grid ct-blog-grid-layout2 <?php echo esc_attr($style); ?>">
