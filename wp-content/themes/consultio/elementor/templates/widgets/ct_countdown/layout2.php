...
?>
<div class="ct-countdown-wrap ct-countdown-layout2 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
	<h5 class="wg-title el-empty"><?php echo esc_attr($wg_title); ?></h5>
