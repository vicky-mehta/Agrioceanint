...
?>
<div id="<?php echo esc_attr($html_id); ?>" class="ct-counter ct-counter-layout9 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
