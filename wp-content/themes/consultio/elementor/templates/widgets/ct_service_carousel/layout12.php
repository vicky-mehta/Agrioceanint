...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-service-carousel12 dot-style-u7 ct-slick-slider">
                                    ...
                                    <div class="item--primary">
                                        ...
                                        <?php if($show_button == 'true') : ?>
                                            <div class="item-readmore">
                                                <a class="btn" href="<?php if(!empty($service_custom_link)) { echo esc_url($service_custom_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>">
                                                    <span>
