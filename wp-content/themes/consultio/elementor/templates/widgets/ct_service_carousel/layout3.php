...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-service-carousel3 ct-slick-slider <?php echo esc_attr($style); ?>">
                    ...
                    <div class="grid-item-holder">
                        ...
                        <?php if($show_button == 'true') : ?>
                            <div class="entry-readmore">
                                ...
                                <a class="text-gradient" href="<?php if(!empty($service_custom_link)) { echo esc_url($service_custom_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>">
                                    <?php if(!empty($button_text)) {
                                        echo esc_attr($button_text);
                                    } else {
                                        echo esc_html__('Read more', 'consultio');
