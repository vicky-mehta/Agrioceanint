...
$item_color = $widget->get_setting('item_color');
...
$load_more = array(
    ...
    'template_type' => 'service_layout15',
);
?>

<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-service-grid15" data-layout="<?php echo esc_attr($layout_type); ?>" data-start-page="<?php echo esc_attr($paged); ?>" data-max-pages="<?php echo esc_attr($max); ?>" data-total="<?php echo esc_attr($total); ?>" data-perpage="<?php echo esc_attr($limit); ?>" data-next-link="<?php echo esc_attr($next_link); ?>">
